...
Blockly.Touch = {}; Blockly.Touch.touchIdentifier_ = null; Blockly.Touch.onTouchUpWrapper_ = null; Blockly.Touch.TOUCH_MAP = {}; goog.events.BrowserFeature.TOUCH_ENABLED && (Blockly.Touch.TOUCH_MAP = {
...
Blockly.Workspace = function(a) {
    ...
    for (var f = this.getAllBlocks(), g = 0; g < f.length; g++) f[g].renameVar(a, b),
    e && f[g].renameVar(e, b);
...
}; Blockly.Workspace.prototype.createVariable = function(a) { - 1 == this.variableIndexOf(a) && this.variableList.push(a)
    ...
    function b(a, b) {
        Blockly.Events.setGroup(!0);
        for (var d = 0; d < a.length; d++) a[d].dispose(!0, !1);
        Blockly.Events.setGroup(!1);
        c.variableList.splice(b, 1)
    }
    var c = this,
    d = this.variableIndexOf(a);
    if ( - 1 != d) {
        for (var e = this.getVariableUses(a), f = 0, g; g = e[f]; f++) if ("procedures_defnoreturn" == g.type || "procedures_defreturn" == g.type) {
            f = g.getFieldValue("NAME");
            Blockly.alert(Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE.replace("%1", a).replace("%2", f));
            return
        }
        1 < e.length ? Blockly.confirm(Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace("%1", e.length).replace("%2", a),
        function(a) {
            a && b(e, d)
        }) : b()
    }
    ...
    for (var b = 0,
    c; c = this.variableList[b]; b++) if (Blockly.Names.equals(c, a)) return b;
    return - 1
...
Blockly.Comment = function(a) {
    ...
    case Blockly.PREVIOUS_STATEMENT:
        if (!b || this != b) {
            ...
            if (a.targetConnection) return a.targetConnection == Blockly.insertionMarkerConnection_ ? !0 : !1
        }
        if (b) if (this == b) {
            if (this.targetConnection) return ! 1
        } else if (this == this.sourceBlock_.nextConnection && a.isConnectedToNonInsertionMarker()) return ! 1;
        break;
    ...
    if (!this.fieldGroup_) {
        ...
        this.mouseUpWrapper_ = Blockly.bindEventWithChecks_(this.getClickTarget_(), "mouseup", this, this.onMouseUp_);
    ...
    this.EDITABLE && a && (this.sourceBlock_.isEditable() ? (Blockly.addClass_(a, "blocklyEditableText"), Blockly.removeClass_(a, "blocklyNonEditableText"), this.getClickTarget_().style.cursor = this.CURSOR) : (Blockly.addClass_(a, "blocklyNonEditableText"), Blockly.removeClass_(a, "blocklyEditableText"), this.getClickTarget_().style.cursor = ""))
    ...
    if (this.visible_ && this.textElement_) {
        ...
        var c = 0;
        this.positionArrow && (c = this.positionArrow(b), b += c);
        this.box_ && (b += 2 * Blockly.BlockSvg.BOX_FIELD_PADDING);
        a = (b - c) / 2;
        this.sourceBlock_.RTL && (a += c);
        this.sourceBlock_.isShadow() && !this.positionArrow && (c = Blockly.BlockSvg.FIELD_WIDTH / 2, a = this.sourceBlock_.RTL ? Math.min(b - c, a) : Math.max(c, a));
...
}; Blockly.constants = {}; Blockly.DRAG_RADIUS = 3; Blockly.SNAP_RADIUS = 48; Blockly.CONNECTING_SNAP_RADIUS = 96; Blockly.CURRENT_CONNECTION_PREFERENCE = 20; Blockly.BUMP_DELAY = 0; Blockly.COLLAPSE_CHARS = 30; Blockly.LONGPRESS = 750; Blockly.SOUND_LIMIT = 100; Blockly.HSV_SATURATION = .45; Blockly.HSV_VALUE = .65; Blockly.SPRITE = {
    width: 96,
    height: 124,
    url: "sprites.png"
    ...
    operators: "operators",
    more: "more"
}; Blockly.DropDownDiv = function() {}; Blockly.DropDownDiv.DIV_ = null; Blockly.DropDownDiv.boundsElement_ = null; Blockly.DropDownDiv.owner_ = null; Blockly.DropDownDiv.ARROW_SIZE = 16; Blockly.DropDownDiv.BORDER_SIZE = 1; Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING = 12; Blockly.DropDownDiv.PADDING_Y = 20; Blockly.DropDownDiv.ANIMATION_TIME = .25; Blockly.DropDownDiv.animateOutTimer_ = null; Blockly.DropDownDiv.onHide_ = 0; Blockly.DropDownDiv.createDom = function() {
    ...
    f = goog.style.getPageOffset(Blockly.DropDownDiv.boundsElement_),
    g = goog.style.getSize(Blockly.DropDownDiv.boundsElement_),
    e = goog.style.getSize(e),
    h;
    b + e.height > f.y + g.height ? d - e.height < f.y ? (c = b + Blockly.DropDownDiv.PADDING_Y, h = !1) : (a = c, c = d - e.height - Blockly.DropDownDiv.PADDING_Y, h = !0) : (c = b + Blockly.DropDownDiv.PADDING_Y, h = !1);
    ...
    h = !1,
    k = !1;
    else a.toolbox || (c = (new DOMParser).parseFromString(Blockly.Blocks.defaultToolbox, "text/xml"), a.toolbox = c.children[0]),
    ...
    v = !!a.realtime,
    x = v ? a.realtimeOptions: void 0,
    q = a.colours;
    if (q) for (var r in q) q.hasOwnProperty(r) && Blockly.Colours.hasOwnProperty(r) && (Blockly.Colours[r] = q[r]);
    this.RTL = l;
    this.oneBasedIndex = w;
    this.collapse = f;
    this.comments = g;
    this.disable = h;
    this.readOnly = b;
    ...
    if (a != this.isVisible()) {
        if (this.pair_) throw "Unable to toggle visibility of paired scrollbars."; (this.isVisible_ = a) ? this.svgGroup_.setAttribute("display", "block") : (this.workspace_.setMetrics({
            x: 0,
            y: 0
    ...
    for (var d = 0,
    e; e = a.inputList[d]; d++) for (var f = 0,
    g; g = e.fieldRow[f]; f++) if (g.name && g.EDITABLE) {
    ...
    } (e = a.getAttribute("inline")) && c.setInputsInline("true" == e); (e = a.getAttribute("disabled")) && c.setDisabled("true" == e); (e = a.getAttribute("deletable")) && c.setDeletable("true" == e); (e = a.getAttribute("movable")) && c.setMovable("true" == e); (e = a.getAttribute("editable")) && c.setEditable("true" == e); (e = a.getAttribute("collapsed")) && c.setCollapsed("true" == e);
...
Blockly.WorkspaceSvg = function(a, b) {
...
}; goog.inherits(Blockly.WorkspaceSvg, Blockly.Workspace); Blockly.WorkspaceSvg.prototype.resizeHandlerWrapper_ = null; Blockly.WorkspaceSvg.prototype.rendered = !0; Blockly.WorkspaceSvg.prototype.isFlyout = !1; Blockly.WorkspaceSvg.prototype.isMutator = !1; Blockly.WorkspaceSvg.prototype.dragMode_ = Blockly.DRAG_NONE; Blockly.WorkspaceSvg.prototype.resizesEnabled_ = !0; Blockly.WorkspaceSvg.prototype.scrollX = 0; Blockly.WorkspaceSvg.prototype.scrollY = 0; Blockly.WorkspaceSvg.prototype.startScrollX = 0; Blockly.WorkspaceSvg.prototype.startScrollY = 0; Blockly.WorkspaceSvg.prototype.dragDeltaXY_ = null; Blockly.WorkspaceSvg.prototype.scale = 1; Blockly.WorkspaceSvg.prototype.trashcan = null; Blockly.WorkspaceSvg.prototype.scrollbar = null; Blockly.WorkspaceSvg.prototype.dragSurface = null; Blockly.WorkspaceSvg.prototype.inverseScreenCTM_ = null; Blockly.WorkspaceSvg.prototype.getInverseScreenCTM = function() {
...
}; Blockly.WorkspaceSvg.prototype.lastRecordedPageScroll_ = null; Blockly.WorkspaceSvg.prototype.inverseScreenCTM_ = null; Blockly.WorkspaceSvg.prototype.getInverseScreenCTM = function() {
    return this.inverseScreenCTM_
}; Blockly.WorkspaceSvg.prototype.updateInverseScreenCTM = function() {
    ...
    this.resizesEnabled_ && (this.scrollbar && this.scrollbar.resize(), this.updateInverseScreenCTM())
    ...
    a ? (this.render(), this.toolbox_ && this.toolbox_.position()) : (Blockly.hideChaff(!0), Blockly.DropDownDiv.hideWithoutAnimation())
        ...
        try {
            ...
            if (!isNaN(c) && !isNaN(d)) {
                ...
                do {
                    ...
                    if (!a) for (var k = b.getConnections_(!1), f = 0, l; l = k[f]; f++) if (l.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d)).connection) {
                        a = !0;
                        break
                    }
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        ...
        d.push(g);
        this.scrollbar && (g = {},
        g.text = Blockly.Msg.CLEAN_UP, g.enabled = 1 < e.length, g.callback = this.cleanUp.bind(this), d.push(g));
        ...
        for (var n = [], k = 0; k < e.length; k++) b(e[k]);
        for (k = g = 0; k < n.length; k++) n[k].isShadow() || g++;
        g = {
            text: 1 == g ? Blockly.Msg.DELETE_BLOCK: Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(g)),
            enabled: 0 < g,
            callback: function() {
                2 > n.length ? c() : Blockly.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", n.length),
                function(a) {
                    a && c()
                })
            }
    ...
    this.isInsertionMarker_ != a && (this.isInsertionMarker_ = a) && (this.setColour(Blockly.Colours.insertionMarker), this.setOpacity(Blockly.Colours.insertionMarkerOpacity), this.svgGroup_.classList.add("blocklyInsertionMarker"))
    ...
    f; f = this.inputList[e]; e++) {
        for (var g = 0,
        h; h = f.fieldRow[g]; g++) c.push(h.getText());
    ...
    if (b.length) {
        ...
        f; f = b[e]; e++) {
            ...
            f.enabled && (goog.events.listen(g, goog.ui.Component.EventType.ACTION, f.callback), g.handleContextMenu = function() {
    ...
    this.inputShapes_[a.name] || a.connection.getShadowDom() || (this.inputShapes_[a.name] = Blockly.createSvgElement("path", {
        "class": "blocklyPath",
    ...
    if (Blockly.dragMode_ == Blockly.DRAG_FREE && a) {
        Blockly.replacementMarker_ ? Blockly.BlockSvg.removeReplacementMarker() : Blockly.insertionMarker_ && (Blockly.Events.disable(), Blockly.insertionMarkerConnection_ && Blockly.BlockSvg.disconnectInsertionMarker(), Blockly.insertionMarker_.dispose(), Blockly.insertionMarker_ = null, Blockly.Events.enable());
    ...
    if (d) {
        do {
            var e = Blockly.getRelativeXY_(d), a = a + e.x, b = b + e.y;
            this.workspace.dragSurface && this.workspace.dragSurface.getCurrentBlock() == d && (e = this.workspace.dragSurface.getSurfaceTranslation(), a += e.x, b += e.y);
            d = d.parentNode
    ...
    if (c) var d = new Blockly.Events.Move(this);
    ...
    c;
    this.RTL ? (c = new goog.math.Coordinate(a.x - b.width, a.y), a = new goog.math.Coordinate(a.x, a.y + b.height)) : (c = new goog.math.Coordinate(a.x, a.y), a = new goog.math.Coordinate(a.x + b.width, a.y + b.height));
    return {
        topLeft: c,
        bottomRight: a
    }
    ...
    if (!this.workspace.options.readOnly) if (this.isInFlyout)"touchstart" == a.type && Blockly.isRightButton(a) && (Blockly.Flyout.blockRightClick_(a, this), a.stopPropagation(), a.preventDefault());
    else {
    ...
    Blockly.Touch.clearTouchIdentifier();
    Blockly.dragMode_ == Blockly.DRAG_FREE || b || (Blockly.Events.fire(new Blockly.Events.Ui(this, "click", void 0, void 0)), b = this.workspace.getBlockById(this.id).getRootBlock(), Blockly.Events.fire(new Blockly.Events.Ui(b, "stackclick", void 0, void 0)));
    Blockly.terminateDrag_(); ! this.getParent() && Blockly.selected.isDeletable() && this.workspace.isDeleteArea(a) ? ((a = this.workspace.trashcan) && setTimeout(a.close.bind(a), 100), Blockly.selected.dispose(!1, !0)) : Blockly.selected && Blockly.highlightedConnection_ && (this.positionNewBlock(Blockly.selected, Blockly.localConnection_, Blockly.highlightedConnection_), Blockly.localConnection_.connect(Blockly.highlightedConnection_), this.rendered && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_: Blockly.localConnection_).getSourceBlock().connectionUiEffect(), this.workspace.trashcan && this.workspace.trashcan.close());
    ...
    if ("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button) a.stopPropagation();
        ...
        Blockly.dragMode_ == Blockly.DRAG_STICKY && goog.math.Coordinate.distance(b, c) * this.workspace.scale > Blockly.DRAG_RADIUS && (Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED), Blockly.dragMode_ = Blockly.DRAG_FREE, Blockly.longStop_(), this.moveToDragSurface_(), this.workspace.setResizesEnabled(!1), Blockly.WidgetDiv.hide(!0), Blockly.DropDownDiv.hideWithoutAnimation(), this.parentBlock_ && this.unplug(), this.setDragging_(!0));
    ...
    for (var e = 0; e < this.draggedBubbles_.length; e++) a = this.draggedBubbles_[e],
    a.bubble.setIconLocation(goog.math.Coordinate.sum(a, d));
    var f = this.getConnections_(!1); (a = this.lastConnectionInStack()) && a != this.nextConnection && f.push(a);
    var g = null,
    h = null,
    ...
    e = !0;
    h && h.type == Blockly.OUTPUT_VALUE ? e = !0 : Blockly.localConnection_ && Blockly.highlightedConnection_ && (f = Blockly.localConnection_.x_ + d.x - Blockly.highlightedConnection_.x_, d = Blockly.localConnection_.y_ + d.y - Blockly.highlightedConnection_.y_, d = Math.sqrt(f * f + d * d), g && k > d - Blockly.CURRENT_CONNECTION_PREFERENCE && (e = !1));
    ...
    a && a != Blockly.highlightedConnection_ && !a.sourceBlock_.isInsertionMarker() && (Blockly.highlightedConnection_ = a, Blockly.localConnection_ = b, b.type == Blockly.OUTPUT_VALUE || b.type == Blockly.PREVIOUS_STATEMENT && a.isConnected() && !this.nextConnection ? this.addReplacementMarker_(b, a) : this.connectInsertionMarker_(b, a));
    Blockly.Events.enable();
    this.isDeletable() && this.workspace.isDeleteArea(d)
}; Blockly.BlockSvg.prototype.addReplacementMarker_ = function(a, b) {
    b.targetBlock() ? (Blockly.replacementMarker_ = b.targetBlock(), Blockly.replacementMarker_.highlightForReplacement(!0)) : a.type == Blockly.OUTPUT_VALUE && (Blockly.replacementMarker_ = b.sourceBlock_, Blockly.replacementMarker_.highlightShapeForInput(b, !0))
    ...
    d != Blockly.insertionMarkerConnection_ && (c.rendered = !0, c.render(), c.getSvgRoot().setAttribute("visibility", "visible"), this.positionNewBlock(c, d, b), d.type != Blockly.PREVIOUS_STATEMENT || c.nextConnection || (Blockly.bumpedConnection_ = b.targetConnection), d.connect(b), Blockly.insertionMarkerConnection_ = d)
}; Blockly.BlockSvg.disconnectInsertionMarker = function() {
    if (Blockly.insertionMarkerConnection_ != Blockly.insertionMarker_.nextConnection || Blockly.insertionMarker_.previousConnection && Blockly.insertionMarker_.previousConnection.targetConnection) if (Blockly.insertionMarkerConnection_.type == Blockly.NEXT_STATEMENT && Blockly.insertionMarkerConnection_ != Blockly.insertionMarker_.nextConnection) {
        ...
        b && b.connect(a)
    } else Blockly.insertionMarker_.unplug(!0);
    else Blockly.insertionMarkerConnection_.targetBlock().unplug(!1);
    if (Blockly.insertionMarkerConnection_.targetConnection) throw "insertionMarkerConnection still connected at the end of disconnectInsertionMarker";
    ...
    10))
}; Blockly.BlockSvg.prototype.updateDisabled = function() {}; Blockly.BlockSvg.prototype.getCommentText = function() {
...
}; Blockly.BlockSvg.render = {}; Blockly.BlockSvg.GRID_UNIT = 4; Blockly.BlockSvg.SEP_SPACE_X = 3 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.SEP_SPACE_Y = 3 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.STATEMENT_BLOCK_SPACE = 3 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.FIELD_HEIGHT = 8 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.FIELD_WIDTH = 12 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.EDITABLE_FIELD_PADDING = 0; Blockly.BlockSvg.FIELD_WIDTH_MIN_EDIT = 13 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.FIELD_WIDTH_MAX_EDIT = 24 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.FIELD_HEIGHT_MAX_EDIT = 10 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.FIELD_TOP_PADDING = .25 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.NUMBER_FIELD_CORNER_RADIUS = 4 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.TEXT_FIELD_CORNER_RADIUS = 1 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.FIELD_DEFAULT_CORNER_RADIUS = 4 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.MIN_BLOCK_X = 8 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.MIN_BLOCK_Y = 16 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.TAB_WIDTH = 2 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.CORNER_RADIUS = 1 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.HAT_CORNER_RADIUS = 8 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.NOTCH_HEIGHT = 8 * Blockly.BlockSvg.GRID_UNIT + 2; Blockly.BlockSvg.NOTCH_WIDTH = 2 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.NOTCH_PATH_DOWN = "c 0,2 1,3 2,4 l 4,4 c 1,1 2,2 2,4 v 12 c 0,2 -1,3 -2,4 l -4,4 c -1,1 -2,2 -2,4"; Blockly.BlockSvg.NOTCH_PATH_UP = "c 0,-2 1,-3 2,-4 l 4,-4 c 1,-1 2,-2 2,-4 v -12 c 0,-2 -1,-3 -2,-4 l -4,-4 c -1,-1 -2,-2 -2,-4"; Blockly.BlockSvg.IMAGE_FIELD_WIDTH = 10 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.IMAGE_FIELD_HEIGHT = 10 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.FIELD_Y_OFFSET = -2 * Blockly.BlockSvg.GRID_UNIT; Blockly.BlockSvg.TOP_LEFT_CORNER_START = "m " + Blockly.BlockSvg.CORNER_RADIUS + ",0"; Blockly.BlockSvg.TOP_LEFT_CORNER = "A " + Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS + " 0 0,0 0," + Blockly.BlockSvg.CORNER_RADIUS; Blockly.BlockSvg.HAT_TOP_LEFT_CORNER_START = "m " + Blockly.BlockSvg.HAT_CORNER_RADIUS + ",0"; Blockly.BlockSvg.HAT_TOP_LEFT_CORNER = "A " + Blockly.BlockSvg.HAT_CORNER_RADIUS + "," + Blockly.BlockSvg.HAT_CORNER_RADIUS + " 0 0,0 0," + Blockly.BlockSvg.HAT_CORNER_RADIUS; Blockly.BlockSvg.renderingMetrics_ = null; Blockly.BlockSvg.MAX_DISPLAY_LENGTH = 4; Blockly.BlockSvg.FIELD_TEXTINPUT_FONTSIZE_INITIAL = 12; Blockly.BlockSvg.FIELD_TEXTINPUT_FONTSIZE_FINAL = 14; Blockly.BlockSvg.FIELD_TEXTINPUT_EXPAND_PAST_TRUNCATION = !0; Blockly.BlockSvg.FIELD_TEXTINPUT_ANIMATE_POSITIONING = !0; Blockly.BlockSvg.metricsAreEquivalent_ = function(a, b) {
    ...
    a = 0;
    for (var b; b = this.inputList[a]; a++) for (var c = 0,
    d; d = b.fieldRow[c]; c++) d.setText(null)
}; Blockly.BlockSvg.prototype.highlightForReplacement = function(a) {
    a ? (this.svgPath_.setAttribute("filter", "url(#blocklyReplacementGlowFilter)"), this.svgGroup_.classList.add("blocklyReplaceable")) : (this.svgPath_.removeAttribute("filter"), this.svgGroup_.classList.remove("blocklyReplaceable"))
}; Blockly.BlockSvg.prototype.getHeightWidth = function(a) {
    var b = this.height,
    c = this.width; ! a && this.getFieldShadowBlock_() && (b += Blockly.BlockSvg.FIELD_Y_OFFSET, b += Blockly.BlockSvg.FIELD_HEIGHT);
    var d = this.getNextBlock();
    d && (a = d.getHeightWidth(a), c += a.width, c -= Blockly.BlockSvg.NOTCH_WIDTH, b = Math.max(b, a.height));
    return {
        height: b,
        width: c
    }
    ...
    b && Blockly.BlockSvg.metricsAreEquivalent_(b, c) ? (c.statement && c.statement.connection && c.statement.targetConnection && c.statement.connection.tighten_(), this.nextConnection && this.nextConnection.targetConnection && this.nextConnection.tighten_()) : (this.height = c.height, this.width = c.width, this.renderDraw_(c), this.renderClassify_(c), this.renderingMetrics_ = c); ! 1 !== a && ((a = this.getParent()) ? a.render(!0) : Blockly.resizeSvgContents(this.workspace));
    Blockly.Field.stopCache()
    ...
    b = 0, c; c = this.inputList[b]; b++) {
        ...
        for (var d = 0,
        e; e = c.fieldRow[d]; d++) e instanceof Blockly.FieldImage && (a.imageField = e),
    ...
    a.statement && (a.width += a.bayWidth + 4 * Blockly.BlockSvg.CORNER_RADIUS + 2 * Blockly.BlockSvg.GRID_UNIT, a.height = a.bayHeight + Blockly.BlockSvg.STATEMENT_BLOCK_SPACE);
    ...
    if (a.imageField) {
        ...
        var f = "scale(1 1)";
        this.RTL && (a.imageField.getFlipRTL() ? (f = "scale(-1 1)", d = -a.width + c.width + Blockly.BlockSvg.SEP_SPACE_X / 1.5) : d = -a.width + Blockly.BlockSvg.SEP_SPACE_X / 1.5);
        b && (this.isInsertionMarker() && b.setAttribute("display", "none"), b.setAttribute("transform", "translate(" + d + "," + e + ") " + f))
    }
    this.getFieldShadowBlock_() && (b = this.getFieldShadowBlock_().getSvgRoot(), c = Blockly.BlockSvg.NOTCH_WIDTH + (a.bayWidth ? 2 * Blockly.BlockSvg.GRID_UNIT + 2 * Blockly.BlockSvg.NOTCH_WIDTH: 0) + a.bayWidth, a.startHat && (c += 2 * Blockly.BlockSvg.GRID_UNIT), this.RTL && (c = -c), b.setAttribute("transform", "translate(" + c + "," + (a.height + Blockly.BlockSvg.FIELD_Y_OFFSET) + ")"))
}; Blockly.BlockSvg.prototype.renderClassify_ = function(a) {
    var b = [];
    this.isShadow_ ? b.push("argument") : (a.statement && b.push("c-block"), a.startHat ? b.push("hat") : a.statement || b.push("stack"), this.nextConnection || b.push("end"));
    ...
    c.startHat ? (a.push(Blockly.BlockSvg.HAT_TOP_LEFT_CORNER_START), a.push(Blockly.BlockSvg.HAT_TOP_LEFT_CORNER)) : this.previousConnection ? (a.push(Blockly.BlockSvg.TOP_LEFT_CORNER_START), a.push(Blockly.BlockSvg.TOP_LEFT_CORNER), a.push("V", c.height - Blockly.BlockSvg.CORNER_RADIUS - Blockly.BlockSvg.SEP_SPACE_Y - Blockly.BlockSvg.NOTCH_HEIGHT), a.push(Blockly.BlockSvg.NOTCH_PATH_DOWN), this.previousConnection.moveTo(b.x, b.y + c.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push("V", c.height - Blockly.BlockSvg.CORNER_RADIUS)) : (a.push("m", c.fieldRadius + ",0"), a.push("A", c.fieldRadius + "," + c.fieldRadius, "0", "0,0", "0," + c.fieldRadius), a.push("V", c.height - c.fieldRadius))
    ...
    if (c.statement) {
        ...
        a.push("a", Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS + " 0 0,1 " + Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS);
        c.bayNotchAtRight && (a.push("v", c.bayHeight - 3 * Blockly.BlockSvg.CORNER_RADIUS - Blockly.BlockSvg.NOTCH_HEIGHT - 2 * Blockly.BlockSvg.GRID_UNIT), a.push(Blockly.BlockSvg.NOTCH_PATH_DOWN));
    ...
    this.isShadow() ? (a.push("a", c.fieldRadius + "," + c.fieldRadius, "0", "0,0", c.fieldRadius + "," + -1 * c.fieldRadius), a.push("v", -1 * (c.height - 2 * c.fieldRadius))) : (a.push("a", Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS + " 0 0,0 " + Blockly.BlockSvg.CORNER_RADIUS + ",-" + Blockly.BlockSvg.CORNER_RADIUS), a.push("v", -2.5 * Blockly.BlockSvg.GRID_UNIT));
    this.nextConnection ? (a.push(Blockly.BlockSvg.NOTCH_PATH_UP), this.width += Blockly.BlockSvg.NOTCH_WIDTH, this.nextConnection.moveTo(this.RTL ? b.x - c.width: b.x + c.width, b.y + c.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), this.nextConnection.targetConnection && this.nextConnection.tighten_(), a.push("V", Blockly.BlockSvg.CORNER_RADIUS)) : this.isShadow() || a.push("V", Blockly.BlockSvg.CORNER_RADIUS)
    ...
    for (var a = 0,
    b; b = this.childBlocks_[a]; a++) if (b.isShadow()) return b;
    return null
    ...
    Today: "TODAY"
}; Blockly.utils = {}; Blockly.cache3dSupported_ = null; Blockly.addClass_ = function(a, b) {
    ...
    if (c = a.getAttribute("transform")) if (c = c.match(Blockly.getRelativeXY_.XY_REGEXP_)) b.x += parseFloat(c[1]),
    c[3] && (b.y += parseFloat(c[3])); (a = a.getAttribute("style")) && -1 < a.indexOf("translate3d") && (a = a.match(Blockly.getRelativeXY_.XY_3D_REGEXP_)) && (b.x += parseFloat(a[1]), a[3] && (b.y += parseFloat(a[3])));
    return b
}; Blockly.getRelativeXY_.XY_REGEXP_ = /translate\(\s*([-+\d.e]+)([ ,]\s*([-+\d.e]+)\s*\))?/; Blockly.getRelativeXY_.XY_3D_REGEXP_ = /transform:\s*translate3d\(\s*([-+\d.e]+)px([ ,]\s*([-+\d.e]+)\s*)px([ ,]\s*([-+\d.e]+)\s*)px\)?/; Blockly.getSvgXY_ = function(a, b) {
    var c = 0,
    d = 0,
    e = 1;
    ...
    if (null !== Blockly.cache3dSupported_) return Blockly.cache3dSupported_;
    ...
    return b.join("")
}; Blockly.genUid.soup_ = "!#$%()*+,-./:;=?@[]^_`{|}~ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"; Blockly.utils.wrap = function(a, b) {
    ...
    if ("keypress" === a.type && this.restrictor_) {
        var b, c = !1;
        if (goog.userAgent.GECKO) if (b = a.charCode, 32 > b || 127 == b) c = !0;
        else {
            if (a.metaKey || a.ctrlKey) c = -1 < Blockly.FieldTextInput.GECKO_KEYCODE_WHITELIST.indexOf(b)
        } else b = a.keyCode;
    ...
    c = a.value;
    c !== a.oldValue_ ? (a.oldValue_ = c, this.setValue(c), this.validate_()) : goog.userAgent.WEBKIT && this.sourceBlock_.render();
    this.resizeEditor_()
...
}; goog.inherits(Blockly.FieldDropdown, Blockly.Field); Blockly.FieldDropdown.CHECKMARK_OVERHANG = 25; Blockly.FieldDropdown.prototype.CURSOR = "default"; Blockly.FieldDropdown.prototype.selectedItem = null; Blockly.FieldDropdown.prototype.init = function() {
    if (!this.fieldGroup_) {
        this.arrowSize_ = 12;
        this.arrowX_ = 0;
        this.arrowY_ = 11;
    ...
    null !== a && (this.text_ = a)
}; Blockly.FieldImage.prototype.render_ = function() {}; Blockly.FieldTextDropdown = function(a, b, c, d) {
    this.menuGenerator_ = b;
    ...
    this.arrow_ || (this.arrowSize_ = 12, this.arrowX_ = 0, this.arrowY_ = 11, this.arrow_ = Blockly.createSvgElement("image", {
        height: this.arrowSize_ + "px",
        width: this.arrowSize_ + "px"
...
}; goog.inherits(Blockly.FieldNumberDropdown, Blockly.FieldTextDropdown); Blockly.Variables = {}; Blockly.Variables.NAME_TYPE = "VARIABLE"; Blockly.Variables.allUsedVariables = function(a) {
    var b;
    ...
    Blockly.registerButtonCallback("CREATE_VARIABLE",
    function(a) {
        Blockly.Variables.createVariable(a.getTargetWorkspace())
    });
    b.push(c);
    for (c = 0; c < a.length; c++) if (Blockly.Blocks.data_variable) {
    ...
    var c = function(d) {
        ...
        function(d) {
            d ? -1 != a.variableIndexOf(d) ? Blockly.alert(Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1", d.toLowerCase()),
            function() {
                c(d)
    ...
    if (this.sourceBlock_) {
        ...
        if (0 <= this.renameVarItemIndex_ && a.getChildAt(this.renameVarItemIndex_) === b) {
            var e = this.getText();
            Blockly.hideChaff();
            Blockly.Variables.promptName(Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", e), e,
            function(a) {
    ...
    if (! ("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
        ...
        Blockly.longStop_();
        if (b) this.createBlockFunc_(Blockly.Flyout.startBlock_)(Blockly.Flyout.startDownEvent_);
    ...
    if (Math.sqrt(a * a + b * b) < this.DRAG_RADIUS) return this.dragMode_ = Blockly.DRAG_STICKY,
    !1;
    ...
    } else "button" == f.type && (f = f.button, g = f.createDom(), f.moveTo(d, c), f.show(), Blockly.bindEvent_(g, "mouseup", f, f.onMouseUp), this.buttons_.push(f), d += f.width + b[e])
    ...
    this.checkboxes_ = []
}; goog.inherits(Blockly.VerticalFlyout, Blockly.Flyout); Blockly.VerticalFlyout.prototype.autoClose = !1; Blockly.VerticalFlyout.prototype.DEFAULT_WIDTH = 250; Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE = 20; Blockly.VerticalFlyout.prototype.CHECKBOX_MARGIN = Blockly.Flyout.prototype.MARGIN; Blockly.VerticalFlyout.prototype.CHECKBOX_SPACE_X = Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE + 2 * Blockly.VerticalFlyout.prototype.CHECKBOX_MARGIN; Blockly.VerticalFlyout.prototype.init = function(a) {
    ...
    if (this.isVisible()) {
        ...
        if (a) {
            ...
            if (this.parentToolbox_) var b = this.parentToolbox_.HtmlDiv.offsetLeft,
    ...
    d = this.getWidth() / this.workspace_.scale, e = c, f = 0, g; g = a[f]; f++) if ("block" == g.type) {
        ...
        e += k.height + b[f]
    } else "button" == g.type && (g = g.button, h = g.createDom(), g.moveTo(c, e), g.show(), Blockly.bindEvent_(h, "mouseup", g, g.onMouseUp), this.buttons_.push(g), e += g.height + b[f])
    ...
    if (!c) throw "No block found in the flyout for id " + a;
    c = c.flyoutCheckbox;
    c.clicked = b;
    ...
    d = !1,
    e = this.dragAngleRange_;
    if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT) c < e && c > -e && (d = !0);
    ...
    e = b.getMetrics();
    this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT && (scrollX = e.viewWidth - this.width_, c.x += scrollX / d - scrollX);
...
}; Blockly.VerticalFlyout.prototype.reflowInternal_ = function() {}; Blockly.Toolbox = function(a) {
    this.workspace_ = a;
    this.iconic_ = !1;
    ...
    this.container_ = a
}; Blockly.DragSurfaceSvg.prototype.SVG_ = null; Blockly.DragSurfaceSvg.prototype.dragGroup_ = null; Blockly.DragSurfaceSvg.prototype.container_ = null; Blockly.DragSurfaceSvg.prototype.scale_ = 1; Blockly.DragSurfaceSvg.prototype.dragShadowFilterId_ = ""; Blockly.DragSurfaceSvg.SHADOW_STD_DEVIATION = 6; Blockly.DragSurfaceSvg.prototype.createDom = function() {
    if (!this.SVG_) {
        ...
        this.dragGroup_ = Blockly.createSvgElement("g", {},
        this.SVG_);
    ...
    b.readOnly || b.hasScrollbars || d.addChangeListener(function() {
        if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
            ...
            if (a.contentTop < g || a.contentTop + a.contentHeight > a.viewHeight + g || a.contentLeft < (b.RTL ? a.viewLeft: c) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth: a.viewWidth + c)) for (var h = d.getTopBlocks(!1), k = 0, l; l = h[k]; k++) {
    ...
    var b = a.options,
    c = a.getParentSvg();
    Blockly.bindEventWithChecks_(c, "contextmenu", null,
    function(a) {
...
var CLOSURE_DEFINES = {
    "goog.DEBUG": !1
}; Blockly.mainWorkspace = null; Blockly.selected = null; Blockly.highlightedConnection_ = null; Blockly.localConnection_ = null; Blockly.draggingConnections_ = []; Blockly.insertionMarkerConnection_ = null; Blockly.insertionMarker_ = null; Blockly.replacementMarker_ = null; Blockly.bumpedConnection_ = null; Blockly.clipboardXml_ = null; Blockly.clipboardSource_ = null; Blockly.dragMode_ = Blockly.DRAG_NONE; Blockly.flyoutButtonCallbacks_ = {}; Blockly.registerButtonCallback = function(a, b) {
    ...
    if (!Blockly.mainWorkspace.options.readOnly && !Blockly.isTargetInput_(a)) if (27 == a.keyCode) Blockly.hideChaff(),
    Blockly.DropDownDiv.hide();
    else if (8 == a.keyCode || 46 == a.keyCode) a.preventDefault();
    else if (a.altKey || a.ctrlKey || a.metaKey) Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected), Blockly.hideChaff(), Blockly.selected.dispose(Blockly.dragMode_ != Blockly.DRAG_FREE, !0), Blockly.highlightedConnection_ && (Blockly.highlightedConnection_.unhighlight(), Blockly.highlightedConnection_ = null))),
